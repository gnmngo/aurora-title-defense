...
const sections = [
  ...
  { id: "chapter-2", label: "II. Review of Related Literature" },
  { id: "role-based-access-control", label: "Role-Based Access Control" },
  { id: "authentication-identity", label: "Authentication & Identity" },
  { id: "information-security", label: "Information Security" },
  { id: "audit-trail", label: "Audit Trail & Accountability" },
  ...
  { id: "chapter-3", label: "III. Technical Background" },
            ...
            <li key={section.id}>
              <button
                ...
                style={{
                  ...
                  backgroundColor: activeId === section.id ? "var(--color-royal-light)" : undefined,
                  borderLeftColor: activeId === section.id ? "var(--color-royal)" : undefined,
                }}
              >
                {section.label}
              </button>
